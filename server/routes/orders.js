...
router.route('/')
	.get((req, res, next) => {
		...
		const selectOrders = 'SELECT O.TICKET_ID, O.ORDER_ID, O.DATE_ORDERED, O.TOTAL_PRICE, O.SHIP_TIME, O.SHIP_DISTANCE, T.TITLE, T.CREATED_AT ' +
...
router.route('/:id')
	.get((req, res, next) => {
		...
		const selectOrder = 'SELECT O.DATE_ORDERED, O.SHIP_TIME, O.SHIP_DISTANCE, T.TITLE, ' +
			'O.TOTAL_PRICE, O.SHIP_NAME, O.SHIP_ADDRESS_LINE_1, O.SHIP_ADDRESS_LINE_2, O.SHIP_CITY, O.SHIP_STATE, O.SHIP_ZIP, ' +
